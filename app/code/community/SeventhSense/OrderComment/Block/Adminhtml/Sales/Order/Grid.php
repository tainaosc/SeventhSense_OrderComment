<?php
class SeventhSense_OrderComment_Block_Adminhtml_Sales_Order_Grid extends Mage_Adminhtml_Block_Sales_Order_Grid
{
    /**
     ...
     *
     * @return SeventhSense_OrderComment_Block_Adminhtml_Sales_Order_Grid
     */
